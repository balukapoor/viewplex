                ...
                <div class="section-payment__inner">
                    ...
                    <form class="section-payment__form"
                        ...
                        <p class="section-payment__summary">
                            You are subscribing to the {{ $plan->name }} subscription for @if($subsc=='yearly') £{{ $plan->yearly }} per year @else £{{ $plan->price }} per month @endif. You will be billed for your plan shortly after clicking on the Subscribe button below and will continue to be billed monthly from today's date until you actively cancel your subscription. For more information, please read our <a href="{{ url('/legal/terms-and-conditions') }}">Terms &amp; Conditions</a>. If you are happy to continue, please click the Subscribe button.
                        </p>
                        
                        <input type="hidden" name="subsc" value="{{ $subsc }}">                        
